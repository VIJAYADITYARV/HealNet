...
import { sendMessage, getConversation, getConversationsList, getSuggestedUsers } from '../controllers/messageController.js';
...
router.get('/suggested', protect as any, getSuggestedUsers as any);
